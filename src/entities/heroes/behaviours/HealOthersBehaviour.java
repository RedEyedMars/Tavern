...
public class HealOthersBehaviour extends Behaviour {
	...
	public final static BehaviourGenerator generator = new BehaviourGenerator("Heal"){
		...
		public Behaviour generate(Hero hero) {
			...
			if(target!=null){
				return new HealOthersBehaviour(target);
			}
			return null;
		}
	};
	...
	public HealOthersBehaviour(Hero target) {
		this.target = target;
	}
	...
	public void act(Entity entity) {
		...
		Skill heal = hero.getSkill("HealMany");
